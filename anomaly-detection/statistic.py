...
class Statistic:
  ...
  def printStatistic(self):
    ...
    print("Number of packets transferred from .251 to .250: " + str(self.packets_250_251_B))
    print("Number of packets transferred from .250 to .252: " + str(self.packets_250_252_A))
    print("Number of packets transferred from .252 to .250: " + str(self.packets_250_252_B))
    print("Number of packets transferred from .250 to .253: " + str(self.packets_250_253_A))
    print("Number of packets transferred from .253 to .250: " + str(self.packets_250_253_B))
    print("Number of packets transferred from .250 to .254: " + str(self.packets_250_254_A))
    print("Number of packets transferred from .254 to .250: " + str(self.packets_250_254_B))
    ...
    print("Total number of Modbus Success responses: " + str(self.modbus_succ_total))
